...
import { CompleteTaskUsecase } from "../../usecases/task/complete.usecase";

export class CompleteTaskController implements IControllerRepository {
    async handle(request: Request, response: Response): Promise<Response> {
        try {
            ...
            await completeTaskUsecase.execute(Number(id));
